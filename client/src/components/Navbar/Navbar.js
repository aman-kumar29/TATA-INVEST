      ...
      <nav className="navbar navbar-expand-lg " data-bs-theme="dark" >
        <div className="container-fluid ">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {authenticated && user?.email === "admin@tatainvest.org" ?
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link to="/admin"><p className="nav-link active mx-2" aria-current="page" >Home</p></Link>
                </li>
                <li className="nav-item">
                  <Link to="/admin"><p className="nav-link active mx-2" aria-current="page" >Users</p></Link>
                </li>
                <li className="nav-item">
                  <Link to="/aboutus"><p className="nav-link active" aria-current="page" >Transactions</p></Link>
                </li>
              </ul>
              : authenticated ? (
